...
const freeDir =
  '/Users/huangshuisheng/Desktop/hss/galaxy-s10/billd-live-flutter';
const ignoreRootDir = ['.DS_Store', '.git', 'node_modules'];
const ignoreIndexOf = [
  path.resolve(proDir, 'lib/stores'),
  path.resolve(proDir, 'lib/utils'),
  path.resolve(proDir, 'lib/views'),
];
